      ...
      <div className="bg-[#0f141b] border border-devshare-border/60 rounded-2xl p-6">
        ...
        <div className="space-y-5">
          <div className="flex items-center justify-between">
            ...
            <button className="text-xs font-black text-red-400 hover:text-red-300 uppercase tracking-wider transition-colors">Revoke</button>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
            ...
            <button className="text-xs font-black text-devshare-blue hover:text-devshare-blue_hover uppercase tracking-wider transition-colors">Update</button>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
            ...
            <button className="text-xs font-black text-devshare-blue hover:text-devshare-blue_hover uppercase tracking-wider transition-colors">Regenerate</button>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
            ...
            <button className="text-xs font-black text-devshare-blue hover:text-devshare-blue_hover uppercase tracking-wider transition-colors">Setup</button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#0f141b] border border-devshare-border/60 rounded-2xl p-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="text-[10px] font-black text-red-400 uppercase tracking-wider">Remove</button>
          </div>
        </div>

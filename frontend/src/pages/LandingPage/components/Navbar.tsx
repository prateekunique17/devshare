...
export const Navbar = () => {
  return (
    <motion.nav 
      ...
      className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-8 py-4 bg-devshare-bg/80 backdrop-blur-md border-b border-devshare-border"
    >
